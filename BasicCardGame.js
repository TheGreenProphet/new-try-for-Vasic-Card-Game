...
function preGameFunction() {            //vorbereitende Funktion
    ...
    enemyHealthPoints, playerHealthPoints = [20,20];        //Festsetzen der Spielerlebenspunkte
    numberOfHandCards = 5;                                  //Festsetzen der maximale Handkartenzahl
    deck = ["Funken","Funken","Funken","Funken","Funken","Glut","Glut","Glut","Glut","Feuerbal","Feuerbal","Feuerbal","Sturm","Sturm","Sturm","Sturm","Sturm","Orkan","Orkan","Orkan","Panic Button","Panic Button","Panic Button","Panic Button","Blithschlag","Blithschlag","Blithschlag","Blithschlag","Erdbeben","Erdbeben","Erdbeben","Heilender Segen","Heilender Segen","Heilender Segen","Heilender Segen","Sintflut","Sintflut","Eiszeit","Eiszeit","Eiszeit"];
   //Deck deklarieren
